  ...
  const handleTransfer = async (e) => {
    ...
    if(transaction){
      ...
      try {
        ...
        await axios.post(
          'https://firestore.googleapis.com/v1/projects/bankmanagement-136e1/databases/(default)/documents/transactions',
          {
            fields: {
              ...
              senderIfscCode: { stringValue: "RAJA051101" },
