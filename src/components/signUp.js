...
const FIRESTORE_BASE_URL = 'https://firestore.googleapis.com/v1/projects/bankmanagement-136e1/databases/(default)/documents';
const STORAGE_BASE_URL = 'gs://bankmanagement-136e1.appspot.com'; // Replace with your Firebase Storage bucket
...
const SignUp = () => {
  ...
  const handleSignUpWithFirebaseAuth = async (email, password) => {
    const API_KEY = 'AIzaSyCv2HxtlZ1LWj6DOQpth331Nb1tv1QmV7Q'; 
...
const fetchAndIncrementAccountNumber = async () => {
  ...
  return (
    <GradientBackground>
      <FormContainer>
        <Typography variant="h4" align="center" gutterBottom style={{ fontWeight: 'bold', color: '#66BB6A' }}>
          Create Your Account
        </Typography>
        ...
        <Grid item xs={12}>
            <UploadButton 
              fullWidth 
              component="label" 
              style={{ border: photoUploaded ? '2px solid #E6FFED' : '2px dashed #B2FBC7', color: photoUploaded ? '#76ff76' : '#ff7676', backgroundColor: photoUploaded ? '#d5ffd5' : 'transparent' }}
            >
          ...
          <TextField
              ...
              helperText="Initial amount should be minimum of 100000"
              InputLabelProps={{ shrink: true }}
              required
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              required
              helperText="At least 8 characters, including one special character"
              InputLabelProps={{ shrink: true }}
            />
          </Grid>
          <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <UploadButton 
              fullWidth 
              component="label" 
              style={{ border: aadhaarUploaded ? '2px solid #E6FFED' : '2px dashed #B2FBC7', color: aadhaarUploaded ? '#76ff76' : '#ff7676', backgroundColor: aadhaarUploaded ? '#d5ffd5' : 'transparent' }}
            >
          ...
          <Grid item xs={12}>
            <UploadButton 
              fullWidth 
              component="label" 
              style={{ border: panUploaded ? '2px solid #E6FFED' : '2px dashed #B2FBC7', color: panUploaded ? '#76ff76' : '#ff7676', backgroundColor: panUploaded ? '#d5ffd5' : 'transparent' }}
            >
